			...
			<ol class="property-list programItem">
				...
				<li class="fieldcontain">
					<span id="creator-label" class="property-label"><g:message code="programItem.creator.label" default="Creator" /></span>
						...
						<span class="property-value" aria-labelledby="creator-label"><g:link controller="programItemCreator" action="show" id="${programItemInstance?.creator?.id}">${programItemInstance?.creator?.encodeAsHTML()}</g:link></span>
				...
				<g:if test="${programItemInstance?.name}">
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="programItem.name.label" default="Name" /></span>
					
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${programItemInstance}" field="name"/></span>
