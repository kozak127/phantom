			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="programItemWorker.user.label" default="User" /></th>
				...
				<g:each in="${programItemWorkerInstanceList}" status="i" var="programItemWorkerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${programItemWorkerInstance.id}">${fieldValue(bean: programItemWorkerInstance, field: "programItem")}</g:link></td>
					
						<td>${fieldValue(bean: programItemWorkerInstance, field: "user")}</td>
