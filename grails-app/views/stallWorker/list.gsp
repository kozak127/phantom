			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="stallWorker.reservation.label" default="Reservation" /></th>
				...
				<g:each in="${stallWorkerInstanceList}" status="i" var="stallWorkerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${stallWorkerInstance.id}">${fieldValue(bean: stallWorkerInstance, field: "reservation")}</g:link></td>
					
						<td>${fieldValue(bean: stallWorkerInstance, field: "stall")}</td>
